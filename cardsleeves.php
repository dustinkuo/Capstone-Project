...
?>
<section id='content'>
    <p id='page-nav'><a href='index.php'>Home</a> > <a href='supplies.php'>Supplies</a> > <span class='current'>Card Sleeves</span></p>
    <section>
        <div id='product-area'>
            ...
            <?php
                ...
                $query = 'select product_id, product_name, product_image, product_price from product where product_type = "card sleeves"';
